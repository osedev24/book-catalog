...
const Cart = () => {
  ...
  return (
    <div>
      ...
      <div className='p-3 flex flex-wrap justify-between w-4/5 mx-auto'>
      <div className='w-full'>
            <h1 className='font-bold text-3xl w-1/1'>My Cart</h1>
            <hr className='w-1/1' />
      </div>
        <div className='w-2/3'>
           {cartBooks.map((book) => (
          ...
          // </div>
           ...
           <article key={book.id} className="p-3 mb-2">
        ...
        <div className='shadow px-3 py-6 w-1/3 mb-3 mt-10 h-full rounded-2xl'>
